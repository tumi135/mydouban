<template>
    <div class="login">
      <div class="db_login_top"><button  class="cancel" @click="goBack">取消</button>登录豆瓣</div>
...
<style scoped>
  ...
  .login .form_item:nth-of-type(1){
    border-top-left-radius: 3px;
    border-top-right-radius: 3px;
  }
  .login .form_item:nth-of-type(2){
    border-bottom-left-radius: 3px;
    border-bottom-right-radius: 3px;
  }
  .login .db_login_form input{
    border: none;
  }
  .db_login .db_login_form .form_btn{
    margin-top: 10px;
  }
  .login .form_btn button{
  ...
  .login .regist_download{
    text-align: center;
    margin-top: 40px;
  }
  .login .regist_download a{
    color: #42bd56;
    font-size: 14px;
    margin: 0 10px;
  }
